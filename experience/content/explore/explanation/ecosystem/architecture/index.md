...
**Why this matters:** Extensions don't activate reliably by default. core-1337's forced evaluation improves this significantly.
...
The fix: explicit evaluation prompts that force Claude to check extensions before responding. See [activation research](../activation/) for methodology.
...
See [1337-extension-builder](/explore/reference/1337-extension-builder/) for complete authoring guide.
...
**Result:** Improved extension activation through forced evaluation.
...
See [how-to guide](/explore/how-to/#test-skill-activation) for usage.
...
**Key insight:** Steps 1-4 happen once. Step 5 happens on every relevant question with improved reliability.

---

## Next Steps

- **[Activation research](../activation/)** - Validation methodology and testing
- **[Extensibility](../extensibility/)** - Build your own plugins
- **[Tutorials](/explore/tutorials/)** - Step-by-step learning
- **[Reference](/explore/reference/)** - Complete plugin specifications
