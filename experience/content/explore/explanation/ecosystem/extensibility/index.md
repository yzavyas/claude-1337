...
example: core-1337's SessionStart hook injects the forced evaluation pattern that improves extension activation.
...
- **skill** - create SKILL.md with skill description (YAML frontmatter) + knowledge. see [1337-extension-builder](../../reference/1337-extension-builder/)
...
2. study [1337-extension-builder](../../reference/1337-extension-builder/) for skill authoring
